...
const configs: Record<string, Config> = {
  ...
  "qie-lend": {
    chains: { [CHAIN.QIEV3]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1" } },
  },
  "strike": {
    chains: { [CHAIN.ETHEREUM]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2021-03-30' } },
    options: { useExchangeRate: true, blacklists: ["0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1"], protocolRevenueRatio: 1 },
  },
  "sumer": {
    chains: {
      [CHAIN.METER]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2023-11-13' },
      [CHAIN.BASE]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2024-01-09' },
      [CHAIN.ARBITRUM]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2023-12-04' },
      [CHAIN.ETHEREUM]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2024-07-07' },
      ...
      [CHAIN.BSC]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2024-08-31' },
      [CHAIN.BERACHAIN]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2025-02-08' },
      [CHAIN.HEMI]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2025-03-06' },
  ...
  "traderjoe-lend": {
    chains: { [CHAIN.AVAX]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2021-10-11' } },
    options: { protocolRevenueRatio: 1 },
  },
//   "venus-finance": {
//     chains: {
//       [CHAIN.BSC]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2020-11-23' },
//       [CHAIN.ETHEREUM]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2024-01-10' },
//       [CHAIN.OP_BNB]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2024-02-16' },
//       [CHAIN.ARBITRUM]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2024-05-30' },
...
//       [CHAIN.OPTIMISM]: { comptroller: "0x46531ea0E7cec64b14181d45F8C6798a1cE45da1", start: '2024-10-01' },
//       [CHAIN.UNICHAIN]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2025-02-08' },
//     },
//     options: { protocolRevenueRatio: 0.6, holdersRevenueRatio: 0.4 },
//   },
  "mare-finance-v2": {
    chains: { [CHAIN.KAVA]: { comptroller: "0x3211d27a1A1B8E40C7974F6951935303e6e56DBE", start: '2023-07-13' } },
  },
  "quantus": {
    chains: {
