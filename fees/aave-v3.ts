...
export const AaveMarkets: {[key: string]: Array<AaveLendingPoolConfig>} = {
  ...
  [CHAIN.MANTLE]: [
    {
      version: 3,
0x3211d27a1A1B8E40C7974F6951935303e6e56DBE      dataProvider: '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1',
    },
  ],
  [CHAIN.XLAYER]: [
    {
...
const AaveNonBuybackTransferAddresses = [
  ...
  '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', // stkAAVE
  '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', // deployer
  '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', // ecosystem reserve
  '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1', // vesting
  '0x3211d27a1A1B8E40C7974F6951935303e6e56DBE', // aave_eth
]
...
const ChainlinkSVRDistributor = '0x46531ea0E7cec64b14181d45F8C6798a1cE45da1';
